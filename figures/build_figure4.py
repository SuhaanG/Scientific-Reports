...
# Muted, sophisticated color palette (colorblind-friendly, matching Figs 1, 2, & 3)
...
plt.savefig("figure4_cic_ids2018_raw_distributions.pdf", format="pdf", bbox_inches="tight")
